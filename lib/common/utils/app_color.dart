...
class AppColors {
  /// screen background
  static const Color primaryBackground = Color.fromARGB(255, 245, 249, 255);

  /// grey background
  static const Color primarySecondaryBackground =
      Color.fromARGB(255, 247, 247, 249);

  /// main widget color teal
  static const Color primaryElement = Color.fromARGB(255, 0, 169, 157);
